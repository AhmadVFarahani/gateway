...
namespace Gateway.Persistence.Migrations
{
    ...
    [Migration("20251022044935_UPDATE-INVOICE-decimal")]
    partial class UPDATEINVOICEdecimal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gateway.Domain.Entities.Contract", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gateway.Domain.Entities.Invoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gateway.Domain.Entities.InvoiceItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gateway.Domain.Entities.UsageLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gateway.Domain.Views.InvoiceItemView", b =>
                {
                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToView("v_Invoice_Item", (string)null);
                });

            modelBuilder.Entity("Gateway.Domain.Views.InvoiceView", b =>
                {
                    b.Property<long>("CompanyId")
                        .HasColumnType("bigint");
                    ...
                    b.ToView("v_Invoice_List", (string)null);
                });
            ...
            modelBuilder.Entity("Gateway.Domain.Entities.InvoiceItem", b =>
                {
                    b.HasOne("Gateway.Domain.Entities.Invoice", "Invoice")
                        .WithMany("Items")
